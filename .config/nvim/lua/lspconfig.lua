...
lspconfig.vimls.setup {
  ...
  vimruntime = '/usr/bin/nvim', -- "/home/centos/.local/share/nvim/lsp_servers/vimls/node_modules/vim-language-server"
    capabilities = capabilities,
    on_attach = on_attach,
    flags = {
      -- This will be the default in neovim 0.7+
...
-- lsp_status.extensions ()
-- local status_hr = lsp_status.extensions.ccls.setup()

 -- Use a loop to conveniently call 'setup' on multiple servers and
-- map buffer local keybindings when the language server attaches
local servers = { 'ccls', 'pyright' }
local inits = { ccls_init, py_init}
-- local hs = { status_hr, {} }
...
-- lspconfig.ccls.setup = lspconfig.ccls.setup  .. { handlers = lsp_status.extensions.ccls.setup() }

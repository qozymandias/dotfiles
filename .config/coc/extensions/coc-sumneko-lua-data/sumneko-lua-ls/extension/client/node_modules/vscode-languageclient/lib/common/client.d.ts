...
export declare namespace ProposedFeatures {
    function createAll(client: FeatureClient<Middleware, LanguageClientOptions>): (StaticFeature | DynamicFeature<any>)[];
    function createDiagnosticFeature(client: FeatureClient<Middleware, LanguageClientOptions>): DynamicFeature<Proposed.DiagnosticOptions>;
    function createNotebookDocumentSyncFeature(client: FeatureClient<Middleware, LanguageClientOptions>): DynamicFeature<Proposed.NotebookDocumentSyncRegistrationOptions>;
}
export {};
